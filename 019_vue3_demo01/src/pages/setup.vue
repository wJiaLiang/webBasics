<template>
	...
	<div>
		<ul class="br_1_000">
			<li>
				<input class="br_1_666" type="text" v-model="firstName" placeholder="firstName">
			</li>
			<li>
				<input class="br_1_666" type="text" v-model="lastName" laceholder="lastName">
			</li>
			<li>
...
<script>
import {computed, reactive, ref, toRefs, readonly, watchEffect,watch} from "vue";
